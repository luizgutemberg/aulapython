...
resumo_furtos = dados.groupby('municipio')['furto_de_veiculo'].sum().reset_index()
...
tabela_ordenada = resumo_furtos.sort_values(
    by='total_de_furtos',
    ascending=False
)
